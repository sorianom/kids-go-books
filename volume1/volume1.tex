...
\begin{enumerate}
\item Take turns with a friend. One is black, the other white. Black plays first.
...
%% \end{tikzpicture}  
  ...
  Subtract Captured Stones, Add Komi
  ...
  \begin{tikzpicture}[overlay, remember picture]
    ...
    \draw (-6.5,7.5+3.5) node[ellipse callout,draw,fill=white,font=\Large,callout absolute pointer={(-5.4,6+2)},align=center,inner sep=0pt] {Booo!\\Black plays first,\\not fair!!!\\White needs komi!\\Boooooo!};
    
    \draw (-8,-2) node {\includegraphics[width=2cm]{imgs/penguin15.png}};
    \draw (-7,0) node[ellipse callout,draw,fill=white,font=\Large,callout absolute pointer={(-7.5,-1.5)},align=center,inner sep=1]{Shouldn't Komi\\be 7.5!?};
    
    \draw (-3,-2) node {\includegraphics[width=2cm]{imgs/penguin4.png}};
    \draw (-2,0) node[ellipse callout,draw,fill=white,font=\Large,callout absolute pointer={(-2.5,-1.5)},align=center]{NO!!! 6.5!!!};
    
    \draw (1,-2) node {\includegraphics[width=2cm]{imgs/penguin36.png}};
    \draw (3,0) node[ellipse callout,draw,fill=white,font=\Large,callout absolute pointer={(1.5,-1.5)},align=center]{I think 7.5...};

    \draw (4.5,-3) node {\includegraphics[width=4cm]{imgs/penguin32.png}};
    \draw (8,1) node[ellipse callout,draw,fill=white,font=\Large,callout absolute pointer={(5.5,-1.5)},align=center,inner sep=1]{Boo... Stop\\fighting! There are\\different rules!\\Booo...};   
  \end{tikzpicture}
...
\vspace{4cm}
  ...
  {\huge What is $6.5$? $6.5$ is more than $6$, but less than $7$.}

  \smallskip
  
  \hspace{-2.5cm}\begin{tikzpicture}
