...
\draw (0,-1) node[align=center,draw,thick,rounded corners,fill=gray,opacity=0.6,inner sep=0.75cm] {\fontfamily{qcr}\selectfont\fontsize{55}{50}\selectfont \contour{orange}{Mon premier}\\\fontfamily{qcr}\selectfont\fontsize{55}{50}\selectfont \contour{orange}{manuel de Go}};
...
{\Large \emph{Traduction de Marc Levivier, Reims no dan, Club de Go de Reims}}
...
\problem{A blanc de jouer: capture!}{b4,a5}{a4}{Combien de pierres as-tu captur\'{e}e(s)? \rectangle}{1}{imgs/penguin8.png}{Vas-y!}
...
\problem{A blanc de jouer: d\'{e}fends!}{j9,h8}{j8}{Combien de pierres as-tu sauv\'{e}e(s)? \rectangle}{1}{imgs/penguin24.png}{D\'{e}fends!}
...
\problem{Blanc défend le plus grand groupe.}{a8,b8,c8,d8,d9,b9,f8,a2,b2,b1,d2,f5,f6}{a7,b7,c7,d7,e9,a3,b3,c1,e5,e6,f4,g5,g6}{Combien de pierres as-tu sauv\'{e}e(s)? \rectangle}{1}{imgs/penguin10.png}{Sauve-le!}
...
\begin{tikzpicture}[remember picture,overlay]
	\draw (10,20) node (penguin) {\includegraphics[width=2.5cm]{imgs/penguin16.png}};
	...
	\draw (10,14) node (penguin) {\includegraphics[width=2.5cm]{imgs/penguin16.png}};
	...
	\draw (10,8) node (penguin) {\includegraphics[width=2.5cm]{imgs/penguin16.png}};
	...
	\draw (10,2) node (penguin) {\includegraphics[width=2.5cm]{imgs/penguin16.png}};
...
\begin{tikzpicture}[overlay, remember picture]
	\draw (10,23) node (penguin) {\includegraphics[width=2.0cm]{imgs/penguin17.png}};
	...
	\draw (10,18.5) node (penguin) {\includegraphics[width=2.0cm]{imgs/penguin17.png}};
	...
	\draw (10,14) node (penguin) {\includegraphics[width=2.0cm]{imgs/penguin17.png}};
	...
	\draw (10,9.5) node (penguin) {\includegraphics[width=2.0cm]{imgs/penguin17.png}};
	...
	\draw (10,5.0) node (penguin) {\includegraphics[width=2.0cm]{imgs/penguin17.png}};
	...
	\draw (10,0.5) node (penguin) {\includegraphics[width=2.0cm]{imgs/penguin17.png}};
...
\newpage
\problem{Noir tue un groupe.}{h9,j8,g8,h7,g9,g7,j7,e1,e2,f2,g2,h2,j2,a5,b5,b6,b7,b8,a9,b9}{a4,b4,c4,d1,d2,d3,f9,f8,f7,g6,h6,j6,e3,f3,g3,h3,j3,c5,c6,c7,c8,c9}{Combien de pierres as-tu capturées? \rectangle}{0}{imgs/penguin18.png}{Pierre au\\milieu!}

\noindent\rule{\textwidth}{2pt}

\problem{A blanc de jouer. Defends ton groupe.}{a2,b1,a3,b3,c2,c3,c1,h9,j8,g8,h7,g9,g7,j7,e1,e2,f2,g2,h2,j2,a5,b5,b6,b7,b8,a9,b9}{a4,b4,c4,d1,d2,d3,f9,f8,f7,g6,h6,j6,e3,f3,g3,h3,j3,c5,c6,c7,c8,c9}{Combien de pierres as-tu sauv\'{e}e(s)? \rectangle}{1}{imgs/penguin19.png}{Wow!}
...
\newpage
  ...
  \begin{tikzpicture}[overlay, remember picture]
    ...
    \draw (6.5,7.5+2) node[ellipse callout,draw,fill=white,font=\Large,callout absolute pointer={(5.4,6+2)},align=center] {Prends ton temps.};
  \end{tikzpicture}
...
%% \end{tikzpicture}  
\newpage
  Soustaire les pierres capturées. Ajouter le komi
  ...
  \begin{tikzpicture}[overlay, remember picture]
    ...
    \draw (-6.5,7.5+3.5) node[ellipse callout,draw,fill=white,font=\Large,callout absolute pointer={(-5.4,6+2)},align=center,inner sep=0pt] {Noir joue en premier\\En contrepartie,\\Blanc a le komi!};
    ...
    \draw (8,1) node[ellipse callout,draw,fill=white,font=\Large,callout absolute pointer={(5.5,-1.5)},align=center,inner sep=1]{En fait...\\Il existe\\différentes règles!};   
  \end{tikzpicture}
...
\begin{tikzpicture}[remember picture, overlay]
	\draw (-2.8,4.9) node[font=\small] {Territoire};
	\draw (-0.6,4.9) node[font=\small] {Prisonniers};
	\draw (1, 4.9) node[font=\small] {Komi};
	
	\draw (-1.9,3.2) node[font=\small] {Territoire};
	\draw (0,3.2) node[font=\small] {Prisonniers};
\end{tikzpicture}
...
\begin{tikzpicture}[remember picture, overlay]
	\draw (-4.8,4) node[font=\small] {Territoire};
	\draw (-2.7,4) node[font=\small] {Prisonniers};
	\draw (-1.2, 4) node[font=\small] {Komi};
	
	\draw (-4,2.3) node[font=\small] {Territoire};
	\draw (-2,2.3) node[font=\small] {Prisonniers};
\end{tikzpicture}        
\end{center}
} % Very ugly, but this closes the \Huge
