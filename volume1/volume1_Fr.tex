...
\vspace{-0.6cm}https://creativecommons.org/licenses/by-nc-sa/4.0/}

  \vspace{0.5cm}
  
  \normalsize{``My First Book of Go Exercises''\\
  Version Française 1.0 - Mars 2026}
\end{center}
...
\newpage
  ...
  \begin{tikzpicture}[overlay, remember picture]
    ...
    \draw (7.5,1) node[ellipse callout,draw,fill=white,font=\Large,callout absolute pointer={(5.5,-1.5)},align=center,inner sep=1] {Bouuuh...\\Arrêtez de\\vous disputer!\\Il y a plusieurs\\règles! Bouuuh...};%{En fait...\\Il existe\\différentes règles!};   
  \end{tikzpicture}
...
\begin{tikzpicture}[overlay, remember picture]
	...
	\draw (7.1,7.5-4) node[ellipse callout,draw,fill=white,font=\Large,callout absolute pointer={(5.4,6-4.5)},align=center,inner sep=0pt] {La pierre ne peut\\pas s'échapper.\\Cela fait un prisonnier\\pour Blanc.};
